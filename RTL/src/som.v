...
always @(posedge sys_clk_1) begin
    ...
    {tx_tick, tx_phase} <= 23'd6184752;
    if (tx_enable) begin
        {tx_tick, tx_phase} <= (tx_phase + 23'd6184752);
    end
    ...
    if (rx_enable) begin
        {rx_tick, rx_phase} <= (rx_phase + 23'd6184752);
    end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-09-25 23:36:40.
//------------------------------------------------------------------------------
